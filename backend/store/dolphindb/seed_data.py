...
class SeedDataManager:
        ...
        return [
            {
                ...
                "api_limit": 5000,
                "schema": {
                    "ts_code": {"type": "SYMBOL"}, "symbol": {"type": "STRING"}, "name": {"type": "STRING"},
                    "area": {"type": "STRING"}, "industry": {"type": "STRING"}, "market": {"type": "STRING"},
            ...
            },
            {
                ...
                "params": {"exchange": "SSE", "start_date": "20100101", "end_date": "20301231", "fields": "exchange,cal_date,is_open,pretrade_date"},
                "primary_keys": ["exchange", "cal_date"],
                "api_limit": 10000,
                "schema": {
                    "exchange": {"type": "SYMBOL"}, "cal_date": {"type": "DATE"},
                    "is_open": {"type": "INT"}, "pretrade_date": {"type": "DATE"},
                },
            },
            {
                ...
                "api_limit": 5000,
                "schema": {
                    "ts_code": {"type": "SYMBOL"}, "trade_date": {"type": "DATE"},
                    "open": {"type": "DOUBLE"}, "high": {"type": "DOUBLE"}, "low": {"type": "DOUBLE"},
                    "close": {"type": "DOUBLE"}, "pre_close": {"type": "DOUBLE"}, "change": {"type": "DOUBLE"},
                    "pct_chg": {"type": "DOUBLE"}, "vol": {"type": "DOUBLE"}, "amount": {"type": "DOUBLE"},
                },
            },
            {
                ...
                "api_limit": 5000,
                "schema": {
                    "ts_code": {"type": "SYMBOL"}, "trade_date": {"type": "DATE"}, "adj_factor": {"type": "DOUBLE"},
                },
            },
            {
                ...
                "date_field": "trade_date",
                "table_name": "sync_daily_basic",
                "params": {"trade_date": "{date}", "fields": "ts_code,trade_date,close,turnover_rate,turnover_rate_f,volume_ratio,pe,pe_ttm,pb,ps,ps_ttm,dv_ratio,dv_ttm,total_share,float_share,free_share,total_mv,circ_mv"},
                "primary_keys": ["ts_code", "trade_date"],
                "api_limit": 6000,
                "schema": {
                    "ts_code": {"type": "SYMBOL"}, "trade_date": {"type": "DATE"},
                    "close": {"type": "DOUBLE"}, "turnover_rate": {"type": "DOUBLE"}, "turnover_rate_f": {"type": "DOUBLE"},
                    "volume_ratio": {"type": "DOUBLE"}, "pe": {"type": "DOUBLE"}, "pe_ttm": {"type": "DOUBLE"},
                    "pb": {"type": "DOUBLE"}, "ps": {"type": "DOUBLE"}, "ps_ttm": {"type": "DOUBLE"},
                    "dv_ratio": {"type": "DOUBLE"}, "dv_ttm": {"type": "DOUBLE"}, "total_share": {"type": "DOUBLE"},
                    "float_share": {"type": "DOUBLE"}, "free_share": {"type": "DOUBLE"},
                    "total_mv": {"type": "DOUBLE"}, "circ_mv": {"type": "DOUBLE"},
                },
            },
            {
                ...
                "date_field": "trade_date",
                "table_name": "sync_stk_limit",
                "params": {"trade_date": "{date}", "fields": "ts_code,trade_date,pre_close,up_limit,down_limit"},
                "primary_keys": ["ts_code", "trade_date"],
                "api_limit": 5000,
                "schema": {
                    "ts_code": {"type": "SYMBOL"}, "trade_date": {"type": "DATE"},
                    "pre_close": {"type": "DOUBLE"}, "up_limit": {"type": "DOUBLE"}, "down_limit": {"type": "DOUBLE"},
                },
            },
            {
                ...
                "date_field": "trade_date",
                "table_name": "sync_stock_st",
                "params": {"trade_date": "{date}", "fields": "ts_code,name,trade_date,type,type_name"},
                "primary_keys": ["ts_code", "trade_date"],
                "api_limit": 1000,
                "schema": {
                    "ts_code": {"type": "SYMBOL"}, "name": {"type": "STRING"},
                    "trade_date": {"type": "DATE"}, "type": {"type": "STRING"}, "type_name": {"type": "STRING"},
                },
            },
            {
                ...
                "params": {"is_new": "N", "fields": "l1_code,l1_name,l2_code,l2_name,l3_code,l3_name,ts_code,name,in_date,out_date,is_new"},
                "primary_keys": [],
                "api_limit": 2000,
                "schema": {
                    "l1_code": {"type": "SYMBOL"}, "l1_name": {"type": "STRING"}, "l2_code": {"type": "SYMBOL"},
                    "l2_name": {"type": "STRING"}, "l3_code": {"type": "SYMBOL"}, "l3_name": {"type": "STRING"},
                    "ts_code": {"type": "SYMBOL"}, "name": {"type": "STRING"},
                    "in_date": {"type": "DATE"}, "out_date": {"type": "DATE"}, "is_new": {"type": "STRING"},
                },
            },
            {
                ...
                "params": {"is_new": "Y", "fields": "l1_code,l1_name,l2_code,l2_name,l3_code,l3_name,ts_code,name,in_date,out_date,is_new"},
                "primary_keys": [],
                "api_limit": 2000,
                "schema": {
                    "l1_code": {"type": "SYMBOL"}, "l1_name": {"type": "STRING"}, "l2_code": {"type": "SYMBOL"},
            ...
            },
            {
                ...
                "params": {
                    "trade_date": "{date}",
                    "fields": "ts_code,trade_date,st_type",
                },
                "primary_keys": ["ts_code", "trade_date"],
                "api_limit": 1000,
                "schema": {
            ...
            },
            {
                ...
                "params": {
                    "is_new": "N",
                    "fields": "l1_code,l1_name,l2_code,l2_name,l3_code,l3_name,ts_code,in_date,out_date",
                },
                "primary_keys": ["l3_code", "ts_code", "in_date"],
                "api_limit": 2000,
                "schema": {
                    "l1_code": {"type": "SYMBOL"},
                    "l1_name": {"type": "STRING"},
    ...
    def _get_default_etl_tasks(self) -> list[dict]:
        ...
        script_index_member_daily = (
            f'daily = select trade_date, ts_code from loadTable("{db_ts}", "sync_daily_data"); '
            f'etl = select ts_code, source, l1_code, l1_name, l2_code, l2_name, l3_code, l3_name, in_date, out_date '
            ...
            f'from joined where isNull(in_date) or (trade_date >= temporalParse(in_date, "yyyyMMdd") '
            f'and (isNull(out_date) or out_date = "" or trade_date < temporalParse(out_date, "yyyyMMdd")))'
        )

        script_stock_daily_info = (
            f'daily = select trade_date, ts_code, open, high, low, close, pre_close, pct_chg, vol, amount '
            f'from loadTable("{db_ts}", "sync_daily_data"); '
            f'basic = select trade_date, ts_code, pe_ttm, pb, total_mv, circ_mv, turnover_rate '
            f'from loadTable("{db_ts}", "sync_daily_basic"); '
        ...
        return [
            ...
            },
            {
                ...
                "source_tables": ["sync_daily_data", "etl_index_member"],
            },
            {
                ...
                "source_tables": ["sync_daily_data", "sync_daily_basic", "etl_index_member_daily"],
            },
        ]
