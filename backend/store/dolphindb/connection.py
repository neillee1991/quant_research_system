...
class DolphinDBConnection:
    ...
    def __init__(self) -> None:
        """初始化连接管理器"""
        self._host: str = settings.database.dolphindb_host
        self._port: int = settings.database.dolphindb_port
        self._user: str = settings.database.dolphindb_user
        self._password: str = settings.database.dolphindb_password
        self._db_path: str = settings.database.db_path
