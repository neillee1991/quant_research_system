...
from app.services.factor_service import FactorComputeService, ComputeResult
...
class TestFactorComputeService:
    ...
    @patch('app.services.factor_service.get_factor')
    @patch('app.services.factor_service.discover_factors')
    def test_compute_factor_success(self, mock_discover, mock_get_factor):
        ...
        # 模拟 TradingCalendar
        with patch('app.services.factor_service.TradingCalendar') as mock_cal:
            mock_cal.get_instance.return_value.offset_trading_days = Mock(return_value="20231201")

            # 模拟 DataConfigLoader
            with patch('app.services.factor_service.DataConfigLoader') as mock_config:
